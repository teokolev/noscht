const allProjects =
        [
                {id:1,isVideo:true, projectMedia:"../assets/nik/NM_Eyeball_Trimmed.mp4",
                        projectName:"WORLD PEACE INSIDE ME", projectType:"*advertisement", projectAuthor:"nik arthur",
                        assets:[{id:101,isVideo:true,assetMedia:"../assets/nik/WPIM EYEBALL/00_HERO_WPIM_EYEBALL.mp4",isSquare:true,isText:true,firstText:"WORLD PEACE INSIDE ME",secondText:"*ADVERTISEMENT",isFirst:true,assetTexts:["<div>A STOP MOTION ANIMATION</div>","<div>MARKER OVERLAYED AN IMAGE</div>","<div>OF THE EYE, SHOWING VARIOUS</div>","<div>FIGURES REPRESENTING THE</div>","<div>STORY OF THE ALBUM BY</div>","<div>MONEYPHONE</div>"]},
                ...
                {id:2,isVideo:false,projectMedia:"../assets/rene/VICTORIA_BECKHAM/HOMEPAGE_VICTORIA_BECKHAM.png",
                        projectName:"VICTORIA BECKHAM - REVERIE",projectType:"*FASHION + LUXURY",projectAuthor:"rene gibson",
                ...
                {id:3,isVideo:true,projectMedia:"../assets/kosta/CONTRALUZ/HOMEPAGE_HERO_CONTRALUZ.mp4",
                        projectName:"CONTRALUZ X MALUMA",projectType:"*HOSPITALITY + BEVERAGE",projectAuthor:"KOSTADIN KOLEV",
                ...
                {id:4,isVideo:true,projectMedia:"../assets/milos/RYAN BEATTY ALBUM COVER/HOMEPAGE_RB_ALBUM_COVER.mp4",
                        projectName:"RYAN BEATTY ALBUM COVER",projectType:"*PRODUCT DESIGN",projectAuthor:"milos mihajlov",
                ...
                {id:5,isVideo:true,projectMedia:"../assets/kosta/FUTURELAND/HOMEPAGE_HERO_FUTURELAND.mp4",projectName:"FUTURELAND",projectType:"*CAMPAIGN",projectAuthor:"kostadin kolev",
                        assets:[]},
